            ...
            {faqs.map((faq, index) => (
              ...
              >
                <button
                  ...
                  className={`flex w-full flex-col sm:flex-row items-start sm:items-center justify-between p-5 sm:p-6 text-left gap-2 sm:gap-4 focus:outline-none ${activeIndex === index ? "bg-[#E9004B] text-white" : ""
                    }`}
                  aria-expanded={activeIndex === index}
                  aria-controls={`faq-content-${index}`}
                >
                  <h3
                    className={`text-base sm:text-lg md:text-xl font-semibold ${activeIndex === index ? "text-white" : "text-black"
                      }`}
                  >
                    {faq.question}
                  </h3>
                  <svg
                    className={`w-5 h-5 shrink-0 transform transition-transform duration-300 ${activeIndex === index ? "rotate-180" : ""
                ...
                >
                  <div className="px-5 sm:px-6 pb-6 text-gray-600 text-sm sm:text-base leading-relaxed">
                    {faq.answer}
                  </div>
                </div>
              </div>
