    ...
    <div className="bg-[#FDFDFD]">
      ...
      <div className="grid grid-cols-1 gap-6 p-6 max-w-7xl mx-auto mt-20 mb-20">
        {sections.map((section, index) => (
          <div
            key={index}
            className={`bg-white p-3 rounded-2xl shadow-md border border-gray-200 flex flex-col md:flex-row ${index % 2 !== 0 ? 'md:flex-row-reverse' : ''
              } items-center overflow-hidden`}
          >
            <div className="md:w-1/2 w-full h-full overflow-hidden rounded-tl-4xl rounded-br-4xl rounded-bl-4xl">
              <img
                src={section.image}
                alt={section.title}
