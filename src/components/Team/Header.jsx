    ...
    return (
        <section className="relative w-full h-[300px] md:h-[350px]">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-start px-6 md:px-16">
                <h1 className="text-3xl md:text-6xl font-bold mb-2">Our Teams</h1>
                <nav className="text-xl">
                    <Link to="/" className="hover:underline hover:text-[#E9004B] transition-colors">foodymat</Link>
                    <span className="mx-2">/</span>
                    <span className="text-[#E9004B] font-medium">Teams</span>
                </nav>
            </div>
        </section>
    )
